...
data_dir = '/courses/PSYC5301.202630/data/ds000114-tutorial/'
results_dir = '/courses/PSYC5301.202630/staff/s.noble/output/'
...
tpm_img ='/courses/PSYC5301.202630/data/TPM.nii'
...
#preproc.connect([(mask_GM, smooth, [('out_file', 'in_files')])])
